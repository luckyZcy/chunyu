<template>
    <el-dialog v-model="state.diagolFormVisible" title='编辑管理员信息' width="500px" align-center draggable>
...
import {updateeditManager} from '../../../api/home'
...
//编辑管理员信息
// const updateEditManager = () => {
//     updateeditManager(formData).then(res => {
//         if (res.code != 0) {
//             ElMessage({
//                 message: res.msg,
//                 type: 'error'
