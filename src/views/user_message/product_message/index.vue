    ...
    <div class="table-top">
      ...
      <div class="table-header">
        ...
        <div class="button-wrapped">
          <el-button type="primary" @click="openDialog(0, {})">添加产品管理员</el-button>
        </div>
      </div>
      <!-- 表格内容 -->
...
import { getTableData, searchAccountData, updateEditManager, updateProductManager, deleteInfo, getPagingData } from '../../../api/login'
//分页
